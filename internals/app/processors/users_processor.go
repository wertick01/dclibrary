...
func (processor *UsersProcessor) FindUser(id int64) (*models.FinalUser, error) {
...
func (processor *UsersProcessor) ListUsers() ([]*models.FinalUser, error) {
...
func (processor *UsersProcessor) UpdateUser(id int64) (*models.User, error) { //!!! ПРОВЕРИТЬ
	...
	changeduser, err := processor.storage.ChangeUserById(id, &user.User)
	if err != nil {
		return &user.User, errors.New("SOMETHING IS WRONG")
	}
...
func (processor *UsersProcessor) DeleteUser(id int64) (*models.User, error) {
	...
	if err != nil {
		return &user.User, errors.New("CANNOT DELETE USER")
	}
